    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("visitChartFull")) {
        ...
        var myChart = new Chart(visitChartFull, {
          type: "LineWithShadow",
          data: {
            labels: ["1929", "1981", "2006", "2011", "2014", "2017", "2021"],
            datasets: [
              {
                label: "Data",
      ...
      if (document.getElementById("conversionChart")) {
        ...
        var myChart = new Chart(conversionChart, {
          ...
          data: {
            labels: ["СЗАО", "САО", "ВАО", "СВАО", "ЮВАУ", "ЦАО", "ЗАО"],
            datasets: [
              {
                label: "",
                data: [14.4, 13.1, 15, 11, 21, 9.8, 15.7],
      ...
      if (document.getElementById("categoryChart")) {
        ...
        var myDoughnutChart = new Chart(categoryChart, {
          ...
          data: {
            labels: ["Дороги ФЗ", "Платные ФТ", "Дороги ОП"],
            datasets: [
              {
                label: "",
