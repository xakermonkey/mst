/* startrek Main Script 

Table of Contents

01. Utils
02. Shift Select
03. startrek Main Plugin
...
/* 03. startrek Main Plugin */
$.startrek = function (element, options) {
    var defaults = {};
    var plugin = this;
    plugin.settings = {};
    var $element = $(element);
    ...
    function init() {
        ...
        if (typeof Chart !== "undefined") {
                        ...
                        datasets: [
                            {
                                ...
                                borderWidth: 2,
                                data: [67650, 63164, 63007, 61377, 60372, 62057, 59656],
                                datalabels: {
                                    align: "end",
                                    anchor: "end"
                                }
                ...
                var myChart = new Chart(visitChart, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: "",
                                data: [67.650, 63.164, 63.007, 61.377, 60.372, 62.057, 59.656],
                                borderColor: themeColor1,
            ...
            var aqiChartCanv = null;

            if (document.getElementById("aquChart")) {
                var aqiChart = document.getElementById("aquChart").getContext("2d");
                if (aqiChartCanv !== null) {
                    aqiChartCanv.destroy();
                }
                aqiChartCanv = new Chart(aqiChart, {
                    type: "LineWithShadow",
                    options: {
                        plugins: {
                            datalabels: {
                                ...
                                yAxes: [
                                    {
                                        ...
                                        ticks: {
                                            beginAtZero: true,
                                            stepSize: (Math.max.apply(null, chartData[s][vev])/4).toFixed(2) ,
                                            min: 0,
                                            max: Math.max.apply(null, chartData[s][vev]),
                                            padding: 0
                                        }
                                    }
                                ],
                ...
                var myChart = new Chart(conversionChart, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: "",
                                data: [0.9, 1.2, 1.1, 1.4, 0.8, 0.7, 1.3],
                ...
                tooltips: {
                    ...
                    custom: function (tooltipModel) {
                        if (tooltipModel && tooltipModel.dataPoints) {
                            ...
                            $textContainer.find(".label").html($.fn.addCommas(yLabel) + " мг/куб.см");
                            $textContainer.find(".value").html(label + "-" + xLabel);
                        }
                    }
                },
                scales: {
            ...
            if (document.getElementById("categoryChart")) {
                ...
                var myDoughnutChart = new Chart(categoryChart, {
                    ...
                    data: {
                        labels: ["Предприятия", "Стройки", "Автодороги"],
                        datasets: [
                            {
                                label: "",
...
$.fn.startrek = function (options) {
    return this.each(function () {
        if (undefined == $(this).data("startrek")) {
            var plugin = new $.startrek(this, options);
            $(this).data("startrek", plugin);
        }
    });
};
